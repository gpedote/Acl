...
if ($actions_exist) {
	...
	echo $this->Html->link('<i class="fa fa-trash-o"></i> ' . __d('acl', 'Clear ACOs'), '/acl/acos/empty_acos/run', array('confirm' => __d('acl', 'Are you sure you want to destroy all existing ACOs ?'), 'class' => 'btn btn-danger', 'escape' => false));
